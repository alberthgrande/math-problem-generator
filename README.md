...
3. **Supabase Credentials**: Add these to your README for testing:
   ```
   SUPABASE_URL: https://jnfuouzymbthnmpozpiy.supabase.co
   SUPABASE_ANON_KEY: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpuZnVvdXp5bWJ0aG5tcG96cGl5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTk0NDczMTQsImV4cCI6MjA3NTAyMzMxNH0.ENi32fgJe4gV9UrvMyQoLP40e0l7RvNOK5fBeua76ls
   ```
